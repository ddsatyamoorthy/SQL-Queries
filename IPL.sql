...
*/
 ...
 select Venue.Venue_name,Match.Match_id,Match.Match_date
 from Venue join Match on Venue.Venue_id = Match.Venue_id;

 -- Winnning Team--
  select Venue.Venue_name,Match.Match_id,Match.Match_date,Result.winning_team_id as winning_team,Team.Team_name
 from Venue join Match on Venue.Venue_id = Match.Venue_id
  join Result on Result.Match_id = Match.Match_id
  join Team on Team.Team_id = Result.winning_team_id;
